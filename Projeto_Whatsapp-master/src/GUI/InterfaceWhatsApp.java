...
public class InterfaceWhatsApp extends javax.swing.JFrame implements Serializable {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txt_pesquisarContatos1, javax.swing.GroupLayout.DEFAULT_SIZE, 207, Short.MAX_VALUE)
    ...
    private void btn_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_addActionPerformed
        // TODO add your handling code here:
        JList<String> lerContatos = jList_Contatos;
        btn_adicionarNumero(txt_pesquisarContatos1.getText());
        btn_add.setVisible(true);

        try {
            if (!btn_add.equals(lerContatos)) {
                btn_add.add(jList_Contatos);
            }
        } 
        catch (UnsupportedOperationException ex) {
            System.out.println("eeeeeeerrroooooo" + ex);
        }
    ...
    private void btn_pesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_pesquisarActionPerformed
        // TODO add your handling code here:
        JList<String> lerContatos = jList_Contatos;
        btn_pesquisar(txt_pesquisarContatos1.getText());
        
        if(btn_pesquisar.equals(lerContatos)){
            
        }
    }//GEN-LAST:event_btn_pesquisarActionPerformed
    private void btn_adicionarNumero(String text) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private void btn_pesquisar(String text) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    /**
